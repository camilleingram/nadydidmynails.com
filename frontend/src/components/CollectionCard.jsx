...
const CollectionCard = () => {
  return (
    <div className="bg-cheetah-background bg-size-[40%] min-h-[7rem] w-[40%] max-w-40 md:max-w-[25%] rounded-[0.3125rem] flex flex-col justify-center items-center gap-2 shrink-0">
