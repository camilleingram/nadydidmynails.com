...
const Footer = () => {
  return (
    <footer className="w-full min-h-[20dvh] flex flex-wrap content-evenly justify-center text-soft-black">
        <h3 className="w-full text-center font-sugiyama text-[2rem] md:text-[2.25rem] ">nadydidmynails</h3>
        <div className="min-h-[7dvh] w-[80%] max-w-104 flex flex-wrap justify-center items-center text-center font-[Merchant] font-extralight text-[0.875rem] md:text-[1.125rem]">
