...
const MailingList = () => {
  return (
    <>
        <div className="justify-items-center self-center md:w-[40%]">
           <h3 className="font-[Amoresa] text-off-white text-[2rem]">Be an Early Bird</h3>
            <p className="font-[Merchant] font-extralight text-[0.75rem] text-center text-off-white w-[65%] md:w-[70%]">Be the first to know about exclusive deals and new releases by joining our mailing list</p> 
        </div>
        
        {/* add action and method attributes */}
        <form name="mailing-list" className="flex flex-col justify-between gap-4 h-[35%] w-[70%] md:w-[40%] max-w-[21.7rem]">
