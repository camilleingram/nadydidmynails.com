...
const NavBar = () => {
  return (
    <nav className="p-5 w-full flex items-center justify-between fixed top-0 left-0 z-20 bg-off-white shrink-0">
        <div className="w-[8%] max-w-8 md:w-[5%] flex flex-col gap-1">
