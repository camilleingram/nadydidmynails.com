...
const Home = () => {
  return (
   <div className="w-screen h-screen bg-off-white overflow-y-auto overflow-x-hidden">
    ...
    <section className="h-[40%] bg-nails bg-cover bg-clip-content bg-center ml-4 mr-4 rounded-[0.375rem] shadow-[0_4px_4px_rgba(0,0,0,0.5)] relative z-10">
      <div className="h-[60%] w-full flex flex-col items-end relative top-7 right-2">
    ...
    <section className="h-[80%] mr-4 ml-4 ">
      ...
      <h2 className="font-[Amoresa] text-[2rem] relative bottom-90">Nady's Favs</h2>
      <div className="h-[60%] w-full relative z-10 bottom-86 flex flex-row flex-wrap justify-center gap-[1.5rem]">
        <ItListCard/>
        <ItListCard/>
        <ItListCard/>
        <ItListCard/>
      </div>
      <img src={longFlowerImg} alt="Long flower" className="h-[70%] relative bottom-150 left-52 -rotate-17 "/>
    </section>
